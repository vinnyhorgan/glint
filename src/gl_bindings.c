...
static const char *kBindingsBootstrap[] = {
    ...
    "    if len(color) == 3:\n"
    "        return (_color_component(color[0]), _color_component(color[1]), _color_component(color[2]), 1.0)\n"
    "    if len(color) == 4:\n"
    "        return (_color_component(color[0]), _color_component(color[1]), _color_component(color[2]), _color_component(color[3]))\n"
